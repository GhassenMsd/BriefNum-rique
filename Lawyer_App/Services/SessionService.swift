...
class SessionService: NSObject {
    ...
    func getAll (completion: @escaping (Array<Session>) -> Void) {
        ...
        if( preferences.object(forKey: "token") != nil){
            ...
            Alamofire.request(Connexion.adresse + "/api/session/getAll",encoding: JSONEncoding.default, headers: ["Authorization": "Bearer " + preferences.string(forKey: "token")!]).responseJSON {
                    response in
