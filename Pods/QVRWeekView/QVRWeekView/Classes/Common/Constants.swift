...
struct LayoutDefaults {
    ...
    static let dayLabelTextColor = UIColor(red: 0/255, green: 58/255, blue: 51/255, alpha: 0.5)
    // Text color of today day label
    static let dayLabelTodayTextColor = UIColor(red: 0/255, green: 58/255, blue: 51/255, alpha: 1.0)
    ...
    static let hourLabelFont = UIFont.boldSystemFont(ofSize: 11)
    ...
    static let hourLabelDateFormat: String = "HH'h'"
    ...
    static let eventLabelTextColor = UIColor.black
    // Default minimum event label scaling
    ...
    static let topBarColor = UIColor(red: 255/255, green: 255/255, blue: 255/255, alpha: 1.0)
    // Color of the hour indicator displayed over the today day view cell.
    static let hourIndicatorColor = UIColor(red: 255/255, green: 255/255, blue: 255/255, alpha: 1.0)
    // Default color for a day view cell. These are days in the future (or today in the future) that are not weekends.
    static let defaultDayViewColor = UIColor(red: 255/255, green: 255/255, blue: 255/255, alpha: 1.0)
    // Color for day view cells that are in the future and weekends.
    static let weekendDayViewColor = UIColor(red: 255/255, green: 255/255, blue: 255/255, alpha: 1.0)
    // Color for passed day view cells that are not weekends.
    static let passedDayViewColor = UIColor(red: 255/255, green: 255/255, blue: 255/255, alpha: 1.0)
    // Color for passed day view cells that are weekend.
    static let passedWeekendDayViewColor = UIColor(red: 255/255, green: 255/255, blue: 255/255, alpha: 1.0)
